...
import challenges.Day3EngineFixPart2.Gear;
import challenges.Day3EngineFixPart2.NumberWithCoordinates;
import java.util.List;
import org.junit.Test;

public class Day3EngineFixPart2UnitTest {

  Day3EngineFixPart2 engineFix = new Day3EngineFixPart2();

  @Test
  public void shouldGetNumberInARowWithCoordinates(){
    String exampleInput = "467..114..";

    List<NumberWithCoordinates> numberWithCoordinates = engineFix.getNumbersWithCoordinates(exampleInput);

    assertThat(numberWithCoordinates).hasSize(2);
    assertThat(numberWithCoordinates.get(0).getNumber()).isNotNull();
    assertThat(numberWithCoordinates.get(0).getCoordinates()).isEqualTo(new int[]{0,2});
    assertThat(numberWithCoordinates.get(1).getNumber()).isNotNull();
    assertThat(numberWithCoordinates.get(1).getCoordinates()).isEqualTo(new int[]{5,7});
  }

  @Test
  public void shouldReturnNoNumber(){
    String exampleInput = "...*......";

    List<NumberWithCoordinates> numberWithCoordinates = engineFix.getNumbersWithCoordinates(exampleInput);

    assertThat(numberWithCoordinates).isEmpty();
  }

  @Test
  public void shouldReturnGearSymbolsWithCoordinates(){
    String exampleInput = "...*....*.";

    List<Gear> symbolsWithCoordinates = engineFix.getGears(exampleInput);

    assertThat(symbolsWithCoordinates).hasSize(2);
    assertThat(symbolsWithCoordinates.get(0).gearCoordinates).isEqualTo(new int[]{2,3,4});
    assertThat(symbolsWithCoordinates.get(1).gearCoordinates).isEqualTo(new int[]{7,8,9});
  }

  @Test
  public void shouldReturnNoSymbol(){
    String exampleInput = "467..114..";

    List<Gear> symbolsWithCoordinates = engineFix.getGears(exampleInput);

    assertThat(symbolsWithCoordinates).isEmpty();
  }

  @Test
  public void shouldReturnGearsWithAdjacentNumbers(){
    String previousLine = "467..114..";
    String currentLine =  "...*......";
    String nextLine =     "..35..633.";

    List<Gear> gears = engineFix.getGearsWithAdjacentNumbers(previousLine, currentLine, nextLine);

    assertThat(gears).isNotNull().hasSize(1);
  }

  @Test
  public void shouldReturnGearsWithCoordinates(){

    List<Gear> gears = engineFix.getGears("...*.....*");

    assertThat(gears).isNotNull().hasSize(2);
    assertThat(gears.get(0)).isInstanceOf(Gear.class);
    assertThat(gears.get(0).getGearCoordinates()).isEqualTo(new int[]{2,3,4});
    assertThat(gears.get(1)).isInstanceOf(Gear.class);
    assertThat(gears.get(1).getGearCoordinates()).isEqualTo(new int[]{8,9,10});
  }

  @Test
  public void listNumbersAdjacentToSymbol() {
    String exampleInput =
          "467..114..\n"
        + "...*......\n"
        + "..35..633.\n"
    ...
    List<Gear> gears =  engineFix.getGearsWithAdjacentNumbers(exampleInput);
    assertThat(gears).hasSize(5);
  }

  @Test
  public void testGetNumbersAdjacentToSymbolsFromThreeLines() {
    ...
    int result =  engineFix.getSumOfGearsRatio(input);

    assertThat(result).isEqualTo(1);
  }

  @Test
  public void getActualExerciseResult() {
    String input =
    ...
    Integer result =  engineFix.getSumOfGearsRatio(input);
    assertThat(result).isEqualTo(1);
  }
}