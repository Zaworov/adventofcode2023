...
import challenges.Day3EngineFix.NumberWithCoordinates;
import java.util.Arrays;
import java.util.List;
import org.junit.Test;

public class Day3EngineFixUnitTest {

  Day3EngineFix engineFix = new Day3EngineFix();
  ...
  @Test
  public void shouldReturnSymbolsWithCoordinates(){
    String exampleInput = "...*....*.";

    List<Integer> symbolsWithCoordinates = engineFix.getSymbolsCoordinates(exampleInput);

    assertThat(symbolsWithCoordinates).hasSize(2);
    assertThat(symbolsWithCoordinates).containsAll(Arrays.asList(3, 8));
  }
  ...
  public void ListNumbersAdjacentToSymbol() {
    ...
    Integer numbersAdjacentToSymbols =  engineFix.getSumOfAdjacentNumbers(exampleInput);
    assertThat(numbersAdjacentToSymbols).isEqualTo(4361);
  ...
  public void testGetNumbersAdjacentToSymbolsFromThreeLines() {
    String previousLine = "...*......\n";
    String currentLine = "..35..633.\n";
    String nextLine = "......#...\n";

    List<Integer> numbersAdjacentToSymbols =  engineFix.getNumbersAdjacentToSymbolsFromThreeLines(previousLine, currentLine, nextLine);

    assertThat(numbersAdjacentToSymbols).hasSize(2).containsAll(Arrays.asList(35, 633));
  }
  ...
  public void getActualExerciseResult() {
    ...
    Integer numbersAdjacentToSymbols =  engineFix.getSumOfAdjacentNumbers(input);
    assertThat(numbersAdjacentToSymbols).isEqualTo(4361);
  }

  @Test
  public void shouldConsiderNumberAdjucentToSymbolsInTheSameLine(){
    String input = "....=.........370...........................48..456......424...-.341*.....554...*807.571............971..958............166......*..........";
    Integer numbersAdjacentToSymbols =  engineFix.getSumOfAdjacentNumbers(input);
    assertThat(numbersAdjacentToSymbols).isEqualTo(1148);
  }

  @Test
  public void shouldConsiderNumberDuplicatesInSameLine(){
    String input = "....=.........370...........................48..456......424...-.341*.....554...*341.571............971..958............166......*..........";
    Integer numbersAdjacentToSymbols =  engineFix.getSumOfAdjacentNumbers(input);
    assertThat(numbersAdjacentToSymbols).isEqualTo(682);
  }
}